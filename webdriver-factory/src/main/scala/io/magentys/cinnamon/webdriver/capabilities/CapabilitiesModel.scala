...
case class AppiumCapabilities(platformName: String,
                              ...
                              browserName: Option[String] = Some(""), //TODO Should this be ''
...
case class AndroidCapabilities(appActivity: Option[String] = None,
                               ...
                               //chromeOptions: Option[Map[String, Any]] = None, // Currently handled by driverExtras
                               ...
                               autoGrantPermissions: Option[Boolean] = None) extends CapabilitiesMapper

case class IOSCapabilities(calendarFormat: Option[String] = None,
