...
public class AjaxStepDef {
    ...
    @Then("^I should see response text if the timeout for ajax to finish is set to (\\d+) seconds$")
    ...
    @Then("^I should not see response text if the timeout for ajax to finish is set to (\\d+) seconds$")
