...
public class AttributeEqualsCondition extends Condition<WebElement> {

    private final String attribute;
    private final String value;

    public AttributeEqualsCondition(final String attribute, final String value) {
    ...
    public boolean equals(final Object o) {
        if (o == this)
            return true;
        if (!(o instanceof AttributeEqualsCondition))
            return false;

        AttributeEqualsCondition rhs = (AttributeEqualsCondition) o;
